...
namespace Course_Management_System.Controllers
{
    ...
    public class CourseController : ControllerBase
    {
        ...
        public async Task<IActionResult> Enroll([FromRoute] Guid courseId)
        {
            ...
            enrollmentRepository.EnrollInCourse(course, userId);
        ...
        public async Task<IActionResult> GetEnrolledCourses()
        {
            ...
            var courses = await enrollmentRepository.GetEnrollendCoursesAsync(userId);

            var coursesResponse = mapper.Map<List<GetCourseRequestDto>>(courses);            
